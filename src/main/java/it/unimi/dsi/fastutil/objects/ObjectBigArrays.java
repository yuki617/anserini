...
/** A class providing static methods and objects that do useful things with {@linkplain BigArrays big arrays}.
	*
	* <p>Since version 8.4.0, many methods previously in this class(e.g., <code>length()</code>) have
	* been deprecated in favor of those in {@link BigArrays}, which can be imported statically.
	*
